...
let myGameArea = {
    ...
    start: function () {
        ...
        function touchstart(e) {
            e.preventDefault();
            myGameArea.touch.toggleMulti = true;
            myGameArea.touch.xb = e.touches[e.touches.length - 1].clientX;
            myGameArea.touch.yb = e.touches[e.touches.length - 1].clientY;
            myGameArea.canvas.removeEventListener("touchstart", touchstart);
            myGameArea.canvas.addEventListener("touchmove", touchmove);
            myGameArea.canvas.addEventListener("touchend", touchend);
            myGameArea.canvas.addEventListener("touchcancel", touchend);
        }

        function touchmove(e) {
            e.preventDefault();
            myGameArea.touch.toggleDrag = true;
            myGameArea.touch.x = e.touches[e.touches.length - 1].clientX;
            myGameArea.touch.y = e.touches[e.touches.length - 1].clientY;
        }
        ...
        function touchend(e) {
            ...
            myGameArea.canvas.removeEventListener("touchcancel", touchend);
        }
